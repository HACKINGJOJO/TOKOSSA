...
11. [PWA et Notifications Push](#11-pwa-et-notifications-push)
12. [Tests Automatises](#12-tests-automatises)
13. [Deploiement Vercel](#13-deploiement-vercel)
14. [Architecture des Fichiers](#14-architecture-des-fichiers)
15. [Fonctionnalites Implementees](#15-fonctionnalites-implementees)
...
│   │   ├── admin/              # API admin (stats, export, etc.)
...
## 15. Fonctionnalites Implementees
...
| Export commandes | OK | Export CSV |
