      ...
      <article className="product-card group">
        ...
        <div className="relative aspect-square overflow-hidden bg-warm-100">
          ...
          <button
            ...
            className={`absolute top-2 right-2 w-8 h-8 flex items-center justify-center rounded-full bg-white/80 backdrop-blur-sm shadow-sm transition-all duration-200 hover:bg-white z-10 ${
          ...
          {!isOutOfStock && (
            <button
              ...
              className="absolute bottom-2 left-1/2 -translate-x-1/2 px-4 py-2 bg-white/90 backdrop-blur-sm rounded-full shadow-lg text-primary-500 font-semibold text-xs flex items-center gap-1.5 translate-y-2 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 hover:bg-white"
            >
        ...
        <div className="p-4">
          ...
          {/* Name */}
          <h3 className="font-medium text-secondary-500 line-clamp-2 mb-2 group-hover:text-primary-500 transition-colors">
            {product.name}
          </h3>
