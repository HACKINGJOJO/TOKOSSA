...
export async function POST(request: NextRequest) {
  try {
    ...
    // Fallback si Cloudinary n'est pas configure
    if (!cloudName || !apiKey || !apiSecret) {
      console.warn('Cloudinary non configure — image placeholder utilisee')
      return NextResponse.json({
        url: '/images/placeholder.jpg',
        publicId: null,
        message: 'Cloudinary non configure — image placeholder utilisee',
      })
    }
